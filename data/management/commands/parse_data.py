...
from data.parser import parse_summary_data, parse_per_region_data
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        raw_regions_data = parse_per_region_data()
        summary = Summary.objects.create(**raw_summary, raw_data=raw_regions_data)
